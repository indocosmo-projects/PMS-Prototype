...
import './CorporateRates.css';
import Tab from 'react-bootstrap/Tab';
import Tabs from 'react-bootstrap/Tabs';

function CorporateRatesModal() {
  ...
  <>
    ...
    >
      <Modal.Header className="bg-info" closeButton>
        <Modal.Title > Add Corporate TA Rates </Modal.Title>
      </Modal.Header>
      <Modal.Body>
              <Tabs
                  ...
                  <table>
                    <tr>
                        <td className="thwidth left">Corporate/TA <span className="asterik">*</span></td>
                        <td className="thwidth left"> 
                        <div class="form-group">
                                <select class="form-control" id="sel1">
                                  <option>OTA</option>
                                  <option>Company</option>
                                  <option>Company T/A</option>
                                </select>
                              </div>
                        </td>
                    </tr>
                ...
                <Tab className='tab-content-bg tab-bg' eventKey="periods" title={<span><i className="bi bi-house-door-fill me-2"/>Periods</span>}>
                        <table>
                          <tr>
                              <td className="thwidth left">Agreement Ref. <span className="asterik">*</span></td>
                              <td className="thwidth left"> 
                                    <div class="form-group">
                                          <select class="form-control" id="sel1">
                                                <option>Active</option>
...
export default CorporateRatesModal;