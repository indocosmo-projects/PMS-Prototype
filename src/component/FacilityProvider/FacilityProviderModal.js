...
import './FacilityProvider.css';
import SwitchTog from '../Common/SwitchTog';

function FacilityProviderModal() {
  ...
  <>
    ...
    >
      <Modal.Header className="bg-info" closeButton>
        <Modal.Title >Facility Provider</Modal.Title>
      </Modal.Header>
      <Modal.Body>
          <table>
              <tr>
              ...
              <tr>
                  <td className="thwidth left">Phone <span className="asterik">*</span></td>
...
export default FacilityProviderModal;